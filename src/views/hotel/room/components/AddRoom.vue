<template>
    ...
    <el-row>
      ...
      <el-col :span="24">
        <el-form-item label="房间封面" prop="coverImg">
         <!--上传图片控件 start-->
          <el-upload :action="uploadURL" name="fileResource" list-type="picture-card"
  ...
  <div class="dialog-button-wrap">
    ...
    <el-button @click="addRoom(ruleFormRef)" type="success" :loading="subLoading" color="#00BFFF">保存</el-button>
  </div>
</template>

<script setup lang="ts">
import { ref,reactive,onMounted,shallowRef } from 'vue'
import { ElMessage,UploadFile,FormInstance,FormRules  } from 'element-plus'
import {getAllRoomTypeListApi,getAllFloorListApi,addRoomApi} from "@/api/hotel/room/room";
